        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('mhs.update', $mahasiswa->id) }}" method="post" class="form-item"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" name="npm" class="form-control" placeholder="Masukkan NPM"
                                            maxlength="9" value="{{ is_null($mahasiswa) ? '' : $mahasiswa->npm }}">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="gender" id="gender" class="form-control">
                                            ...
                                            <option value="P" {{ $mahasiswa->gender == 'P' ? 'selected' : '' }}>Perempuan
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea name="alamat" id="alamat" cols="2" rows="3" class="form-control"
                                            style="resize: none"
                                            value="Masukkan Alamat">  {{ is_null($mahasiswa) ? '' : $mahasiswa->alamat }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
